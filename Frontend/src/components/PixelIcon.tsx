...
// Item D da rodada de melhorias pós-Fase-6 — revertido. A tentativa
// anterior era um fator de escala por ícone pra igualar o PREENCHIMENTO
// visual (quanto do quadro de 16×16 o desenho ocupa). Na prática isso
// piorou a queixa original: numa fileira que já era uniforme (4 ícones a
// 18px cada), a correção produziu 4 tamanhos DIFERENTES (15–22px) — o que
// o olho lê como "desalinhado" é a CAIXA (width/height), não a folga
// interna do desenho. `size=` volta a valer exatamente o que cada chamada
// passa; ficar uniforme dentro de uma mesma fileira é responsabilidade de
// quem chama (usar o mesmo `size` para ícones do mesmo grupo visual).
