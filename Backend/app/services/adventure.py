...
INICIOS: dict[str, dict[str, Any]] = {
    "caravana_partida": {
        "nome": "A ponte que cai", "resumo": "Uma caravana, uma ponte desabando e um pedido de socorro dos dois lados.",
        "tom": "Resgate e lealdade", "icone": "bridge", "local": "Ponte dos Sinos", "hora": 17,
        "clima": "Chuva oblíqua",
        ...
        "opcoes": ["Prender a corda e resgatar a criança", "Alcançar a mala pelo corrimão", "Coordenar todos no resgate"],
        ...
        "atos": [
            ("O peso de uma escolha", "Resolver o desastre e assumir o efeito sobre quem foi ajudado ou deixado para trás."),
            ...
            ("Quem atravessa amanhã", "Decidir com os sobreviventes quem controla a ponte e conectar o acordo ao seu objetivo."),
        ],
    },
    "baile_mascaras": {
        "nome": "A última dança", "resumo": "Um baile clandestino; a pessoa que veio procurar aponta para uma taça envenenada.",
        "tom": "Intriga e infiltração", "icone": "mask", "local": "Palácio das Máscaras", "hora": 22,
        "clima": "Noite abafada",
        ...
        "opcoes": ["Impedir discretamente o próximo brinde", "Seguir quem trouxe a bandeja", "Confrontar a regente sobre o convite"],
        ...
        "atos": [
            ...
            ("Depois da última dança", "Assumir as consequências públicas do acordo e buscar seu objetivo com os vínculos restantes."),
        ],
    },
    "julgamento_cinzas": {
        "nome": "O julgamento das cinzas", "resumo": "Uma testemunha muda o depoimento; agora você é parte do julgamento.",
        "tom": "Mistério e justiça", "icone": "scales", "local": "Tribunal de Cinza", "hora": 10,
        ...
        "opcoes": ["Examinar a página diante do tribunal", "Pedir que a testemunha seja ouvida", "Abrir uma rota de fuga pelos arquivos"],
    ...
    "farol_afogado": {
        "nome": "O farol sob a maré", "resumo": "Um naufrágio transmite sinais do fundo do mar; a vila apaga suas luzes.",
        "tom": "Exploração e horror brando", "icone": "lighthouse", "local": "Farol da Maré Oca", "hora": 3,
        "clima": "Névoa salgada",
        ...
        "opcoes": ["Investigar o sinal antes de acender", "Preparar um resgate pela escada", "Ouvir a confissão do guardião"],
        ...
        "atos": [
            ...
            ("Um porto para voltar", "Determinar quem pode regressar e o que essa reparação significa para seu objetivo."),
        ],
    },
    "floresta_memorias": {
        "nome": "A floresta que lembra", "resumo": "Árvores repetem uma lembrança sua; um povoado está perdendo os próprios nomes.",
        "tom": "Fantasia e identidade", "icone": "tree", "local": "Bosque dos Nomes", "hora": 6,
        ...
        "opcoes": ["Ajudar a pessoa a reconstruir seu nome", "Seguir o toque até o sino", "Perguntar à jardineira pelas árvores"],
        ...
        "atos": [
            ...
            ("O direito de lembrar", "Encontrar uma solução com consentimento para pessoas que querem destinos diferentes."),
            ("Raízes e caminhos", "Escolher o futuro do bosque sem reescrever o passado do herói e retomar seu objetivo."),
        ],
    },
    "ultimo_trem": {
        "nome": "O último trem de éter", "resumo": "Uma máquina arcana sem freios corre para uma estação que não existe no mapa.",
        "tom": "Ação e engenhos arcanos", "icone": "train", "local": "Expresso de Éter", "hora": 23,
        ...
        "opcoes": ["Alcançar a locomotiva pelo teto", "Organizar os passageiros no corredor", "Examinar o lacre e falar com a maquinista"],
        ...
        "atos": [
            ...
            ("A estação que falta", "Definir um destino que responda à disputa entre passageiros, carga e donos da linha."),
            ("O próximo bilhete", "Assumir o custo da chegada e decidir como a nova rota serve ao seu objetivo."),
        ],
    },
    "cerco_aurora": {
        "nome": "Até a aurora", "resumo": "Um portão sitiado, refugiados do lado de fora e um inimigo disposto a conversar.",
        "tom": "Tática e liderança", "icone": "castle", "local": "Portão da Aurora", "hora": 4,
        "clima": "Vento frio",
        ...
        "opcoes": ["Coordenar uma abertura protegida", "Negociar uma trégua com a emissária", "Procurar passagem pelo aqueduto"],
        ...
        "atos": [
            ...
            ("Quando amanhecer", "Construir o pós-cerco com os sobreviventes e ligar sua responsabilidade ao objetivo pessoal."),
        ],
    },
    "heranca_maldita": {
        "nome": "A casa que o escolheu", "resumo": "Uma casa impossível reconhece você como herdeiro; seus moradores discordam.",
        "tom": "Enigmas e vínculos", "icone": "key", "local": "Solar das Portas Vivas", "hora": 19,
        "clima": "Garoa morna",
        ...
        "opcoes": ["Ler o contrato à procura de uma brecha", "Ouvir os moradores antes de assinar", "Investigar as portas e a origem da casa"],
...
def catalogo_aventura() -> dict:
    return {
        "inicios": [{"id": "surpresa", "nome": "Surpreenda-me", "resumo": "Uma abertura escolhida para esta campanha.",
                     "tom": "Destino aberto", "icone": "dice"}]
        + [{"id": chave, **{campo: inicio[campo] for campo in ("nome", "resumo", "tom", "icone")}}
           for chave, inicio in INICIOS.items()],
        "temperamentos": TEMPERAMENTOS.copy(), "dificuldades": DIFICULDADES.copy(),
    }
...
def preparar_abertura(char: Any, semente: int | None = None) -> dict:
    ...
    return {
        "inicio_aventura": escolhido, "semente_aventura": semente,
        "local_inicial": inicio["local"], "local_inicial_descricao": inicio["descricao"],
        "clima_inicial": inicio["clima"], "hora_do_dia": inicio["hora"],
        "nome_missao": inicio["nome"], "objetivo_missao": inicio["objetivo"],
        "intro_narrativa": "\n\n".join([
            inicio["cena"].format(**nomes), identidade,
        ...
        "opcoes": inicio["opcoes"].copy(), "chaves": chaves,
...
def contexto_campanha(heroi: Any, mundo: Any) -> str:
    ...
    char = SimpleNamespace(
        inicio_aventura=inicio, nome=heroi.nome, raca=heroi.raca, classe=heroi.classe,
